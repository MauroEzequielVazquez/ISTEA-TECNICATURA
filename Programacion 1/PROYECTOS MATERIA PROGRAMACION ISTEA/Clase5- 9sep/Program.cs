namespace Clase5__9sep
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*int cantOvejas = 199;//Cambiar a 121 para ver el efecto
            if (cantOvejas >= 120)
            {
            ...
            */
            ...
            //string resultado2 = ingreso.Substring(5, 3); //desde donde quiero empezar a leer el texto, y cuantos caracteres quiero tomar
            //Console.WriteLine(resultado);      //osea muestra desdeel 5 ,, 3 para delante,, muestra mun..si no pones nada lee todo y si pones otro parametro corta ahi
